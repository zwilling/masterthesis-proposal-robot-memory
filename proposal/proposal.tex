...
reach a goal.
%% There are countless applications, some with major impact
...
are event-triggers and a virtual knowledge base. The event-trigger
...
For the time of the thesis,
we focus on two applications which can especially profit from the
robot memory and will be used for evaluation. On the one hand,
...
memory is needed as flexible and scalable long-time storage of
various facts about a domestic environment, how to perform actions and
to learn spatio-temporal distributions from observed object positions.
...
\subsubsection{Software development expandability, Versatility}
