...
possible to aggregate results using the \emph{Map-Reduce}\todo{reference} paradigm
...
memory and the integration into planner and reasoner formalisms. For
this proposal we focus on the integration into Golog.
...
of underlying database and all computable documents:
...
abstraction~\cite{software-architecture}\todo{nagl ref?}, to allow reusability and
