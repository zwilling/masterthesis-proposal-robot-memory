...
\emph{CLIPS rules engine: } The reasoner we currently use in the RCLL
...
antecendent in \reflist{lst:clips-rule} there have to be fitting
...
distributed database. This would be advantageous\todo{spelling}
...
\emph{Planning Domain Definition Language (PDDL): } PDDL is a
