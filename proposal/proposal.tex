...
\emph{\todo{(on-demand?)}computable knowledge} and
\emph{event-triggers}.  The concept of computable knowledge allows
...
of unnecessary effort. Moreover computable knowledge allows deriving
