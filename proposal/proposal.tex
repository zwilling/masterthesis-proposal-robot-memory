...
\item Trigger
\item modules, query/request modification, parsing with mongo, then analyzing
\item virtual knowledge function parameters, generate into mongo, execute query on mongoxs
\item existing prototype
\end{itemize}
