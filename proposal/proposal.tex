...
available as Open Source and developed primarily at the
...
navigation, perception, reasoning and behavior execution.
The binary components can be loaded as \emph{plugins} at run-time.
...
application. One limitation is the strict rule, that only one component can write an interface to provide information. This rule is very usefull for 

%current over-component robot memory
%limitations (long-term, sharing, dynamicity)

% memory stuff at the time (bb)
