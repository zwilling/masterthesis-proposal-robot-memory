...
architectural design of a generic robot memory


\todo[inline]{finish}
\begin{itemize}
\item RM compact
\item background roocup, application rcll @home, fawkes, planner reasoner clips
  pddl motion planer, mongodb
\item related work 
\item Challenges
\item Impact
\item Contribution/Conzept
\end{itemize}
...
%% between different knowledge based systems and multiple robots and to
%% allow hybrid reasoning based on a capable and efficient storage of
%% spatio-temporal and symbolic knowledge.
