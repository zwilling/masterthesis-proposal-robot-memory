...
knowledge of any type and provide efficient querying and long-time
storage. As a central storage, it allows multiple planners and
reasoners to share the same world model. This way multiple planners
and reasoners can be combined to utilize their specialized strengths
and compensate for their weaknesses.

\begin{itemize}
\item Idea Robot Memory -> advantages
\item ideas trigger, vkb
