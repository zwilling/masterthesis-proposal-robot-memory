...
\begin{frame}
  \tableofcontents[]
\todo[inline]{move to top of frames}
\end{frame}
\addtocounter{framenumber}{-1}
...
\begin{frame}
  ...
  \item[Operation Manager]%<uncover@1->
    ...
    \item Automated startup and configuration of MongoDB % as sub process
    \end{itemize}
  \item[Computable Manager]%<uncover@2->
                \hfill \\
    \begin{itemize}
    \item Registering computables
    \item Evaluates whether queries require computables
    \item Caches of computed documents
    %\item Blackboard and transform computable
    \end{itemize}
  \item[Trigger Manager]%<uncover@3->
                \hfill \\
    \begin{itemize}
...
\begin{frame}
  ...
  \item[Experience from evaluation scenarios]%<uncover@1->
    ...
    \end{itemize}
  \item[Expresiveness vs. Computational Complexity]%<uncover@2->
                \hfill \\
    \begin{itemize}
  ...
  \begin{columns}
    \begin{column}{0.55\textwidth}
      ...
      \item[Tidy up scenario] \hfill \\
        \begin{itemize}
        \item Robot Memory with informations about objects
          \begin{lstlisting}[style=SmallJSON,
            framexleftmargin=5pt, xleftmargin=0pt,
            morekeywords={}, numbers=none]
{ name: "coffee machine",
...
\todo[inline]{future work}
  \begin{block}{Document-oriented Robot Memory} \centering\bfseries The generic robot memory is capable of
