...
and execute it step by step. The first thesis by Schäpers uses reactive answer set
programming with real-time constraints~\cite{bjoern-thesis} and the
second one by Löbach uses a PDDL planner and converts the resulting plan into a
