...
\todo[inline]{write summary, this is only the proposal into}
\color{gray}
...
\todo[inline]{summary content:}
debug problems + additional implementation time for interface vs. time savings
