...
which informations can be infered by made observations. The central
...
executiong the action. Depending on the formalism used by the planning
systems, it is possible to minimize costs associated with actions,
plan in temporily constrained environments, or plan for an multi-agent
system.
...
between multiple reasoning and planning systems by tranforming
