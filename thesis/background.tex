...
\todo[inline]{ definition knowledge based system here or in introduction?}
...
results. \todo[inline]{introduce Caesar? Mention @Home simulation?} 
...
The open source robot software framework \emph{Robot Operating System
  (ROS)}\footnote{\url{http://www.ros.org}} is a widely used
...
complex objects (e.g. dates) and nested sub-documents. Therefore the documents
