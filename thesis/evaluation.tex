...
\todo[inline]{synchronization mongodb changes, instead of changes and full wm in protobuf}
\todo[inline]{covered features rcll, blocksworld}
\todo[inline]{CLIPS as executive for RCLL as in blocks world}