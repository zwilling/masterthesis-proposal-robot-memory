...
\todo[inline]{Difference simulation-real world (almost same for robot
  memory, no possibility to test because of missing field, but
  distribution and full game already tested)} A central component of
