...
on \reflst{lst:template} and fills in the information, which is
...
\begin{wrapfigure}{r}{0.3\textwidth}
  ...
  \label{fig:openrave}
\end{wrapfigure}
\todo[inline]{OpenRAVE figure with drawn path?}
\reffig{fig:openrave} shows the motion planner scene OpenRAVE
...
\todo[inline]{mention attaching of blocks to hand in skill?}