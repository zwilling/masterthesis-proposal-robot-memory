...
KBS. It can also bridge to specific concepts used by the KBS, such as
...
collections. It is also possible to rename keys of key-value pairs in
documents to obtain the correct identifiers used in the KBS.
...
\todo[inline]{add data-flow examples as UML sequence diagram?}
