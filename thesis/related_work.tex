...
\refsec{sec:rw-robmems} presents other information storage systems for
robots with similar
\todo[inline]{superset term for robot memories} approaches and
...
\refsec{sec:basis-representation}. \refsec{sec:mongodb-extensions} then
...
\todo[inline]{denormalization, horizontal scaling}
